...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupal7:qwe123@localhost/drupal7?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://drupal7:qwe123@localhost/civicrm?new_link=true');
  }
}
...
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/html/drupal/sites/devopscompucorp.tk/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://devopscompucorp.tk/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'edec5d99897761309be0b2d83cd01009');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/html/drupal/sites/devopscompucorp.tk/files/civicrm/templates_c//mail.log');
// }
